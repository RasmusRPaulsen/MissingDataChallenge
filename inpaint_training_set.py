...
def inpaint_training_set(settings):
    print("InPainting the training set")
    ...
    inpainted_result_dir = os.path.join(output_data_dir, "inpainted_training")
...
if __name__ == '__main__':
    ...
    if config.settings is not None:
        inpaint_training_set(config.settings)
